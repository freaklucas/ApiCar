...
namespace ApiCar.Migrations
{
    ...
    [Migration("20241004013135_TestDrive")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApiCar.Models.Dealership", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApiCar.Models.TestDrive", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApiCar.Models.CarListing", b =>
                {
                    ...
                    b.HasOne("ApiCar.Models.Dealership", "Dealership")
                        .WithMany("CarListings")
            ...
            modelBuilder.Entity("ApiCar.Models.TestDrive", b =>
                {
                    ...
                    b.HasOne("ApiCar.Models.User", "User")
                        .WithMany("TestDrives")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
